...
function drawRestartBubble() {
  ...
  ctx.beginPath();
  ctx.moveTo(17, 15);
  ctx.bezierCurveTo(6, 28, -13, 27, -22, 10);
  ctx.bezierCurveTo(-30, -6, -22, -22, -4, -24);
  ctx.bezierCurveTo(8, -25, 18, -20, 24, -10);
  ctx.stroke();
  ctx.shadowBlur = 0;
  ...
  ctx.beginPath();
  ctx.moveTo(13, 12);
  ctx.bezierCurveTo(5, 20, -9, 20, -15, 8);
  ctx.bezierCurveTo(-20, -2, -14, -14, -2, -16);
  ctx.bezierCurveTo(7, -17, 14, -13, 18, -7);
  ctx.stroke();
